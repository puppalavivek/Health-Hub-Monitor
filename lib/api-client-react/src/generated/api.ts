 ...
 */
export const getDocument = async (id: number, options?: RequestInit): Promise<DocumentWithChunks> => {

  return customFetch<DocumentWithChunks>(getGetDocumentUrl(id),
  {
    ...options,
    method: 'GET'
 ...
 */
export const getDocumentStats = async ( options?: RequestInit): Promise<CorpusStats> => {

  return customFetch<CorpusStats>(getGetDocumentStatsUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const queryDocuments = async (queryInput: QueryInput, options?: RequestInit): Promise<unknown> => {

  return customFetch<unknown>(getQueryDocumentsUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getListQueryHistoryUrl = () => {




  return `/api/queries/history`
}

/**
 * @summary List recent query history
 */
export const listQueryHistory = async ( options?: RequestInit): Promise<QueryRecord[]> => {

  return customFetch<QueryRecord[]>(getListQueryHistoryUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListQueryHistoryQueryOptions = <TData = Awaited<ReturnType<typeof listQueryHistory>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listQueryHistory>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListQueryHistoryQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listQueryHistory>>> = ({ signal }) => listQueryHistory({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listQueryHistory>>, TError, TData> & { queryKey: QueryKey }
}

export type ListQueryHistoryQueryResult = NonNullable<Awaited<ReturnType<typeof listQueryHistory>>>
...
export function useListQueryHistory<TData = Awaited<ReturnType<typeof listQueryHistory>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listQueryHistory>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListQueryHistoryQueryOptions(options)
